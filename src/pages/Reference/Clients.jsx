            ...
            <div className="row p-5 justify-content-center gap-sm-2 gap-md-2">
                ...
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>NovoMed Dubai Marina</Card.Title>
                            <Card.Text className='text-white'>
                                Dubai Marina
                            </Card.Text>
                        </Card.Body>
                ...
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>NovoMed Dubai</Card.Title>
                            <Card.Text className='text-white'>
                                Dubai
                            </Card.Text>
                        </Card.Body>
                ...
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>Berlin Medical and Rehabilitation Centre</Card.Title>
                            <Card.Text className='text-white'>
                ...
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>NMC ProVita International Centre</Card.Title>
                            <Card.Text className='text-white'>
                                Al-Ain 2017 - Care and Rehabilitation
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>NMC ProVita International Centre</Card.Title>
                            <Card.Text className='text-white'>
                                Abu Dhabi - Care and Rehabilitation
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>NMC ProVita International Centre</Card.Title>
                            <Card.Text className='text-white'>
                                Al-Ain - Care and Rehabilitation
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-md-3 col-sm-auto mb-md-4">
                    <Card id="project-content">
                        ...
                        <Card.Body className='container-color'>
                            <Card.Title className='text-white'>Moon Flower, Hospital 100 Beds</Card.Title>
                            <Card.Text className='text-white'>
                                United Arab Emirates
                            </Card.Text>
                        </Card.Body>
